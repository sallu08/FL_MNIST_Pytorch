...
# Define the India Campus CNN model
class CNN(nn.Module):
    def __init__(self):
...
def load_partition():
    ...
    test_data = datasets.MNIST(root='./data', train=False, download=True, transform=transform)  #total 1000 images

    train_data1 = Subset(train_data, indices=list(range(10000, 15000)))  # 5000 samples for training set
    test_data1 = Subset(test_data, indices=list(range(1000, 2000)))      # 1000 samples for test set
