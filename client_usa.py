...
def load_partition():
    ...
    train_data1 = Subset(train_data, indices=list(range(20000, 25000)))  # 5000 samples for training set
    test_data1 = Subset(test_data, indices=list(range(2000, 3000)))      # 1000 samples for test set
